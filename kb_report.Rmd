...
Unfortunately, the KB documentation about how to access the WoS-KB is a bit outdated. Here, we follow the advice from the DZHW Office and connect to the WoS-KB using the following packages
